import ProcessOptions from "@renderer/interfaces/ProcessOptions";
import ApiResponse from "@renderer/interfaces/ApiResponse";
import ApiError from "@renderer/interfaces/ApiError";
...
export class ApiService {
   ...
   */
  static connectWebSocket(onMessage: (data: unknown) => void): WebSocket {
