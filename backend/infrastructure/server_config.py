...
class FastAPIServer(FastAPIAdapter):
  def __init__(self):
    ...
    self.add_middleware(SecurityMiddleware, max_file_size_mb=max_file_size, rate_limit_per_minute=rate_limit)
    ...
    self.add_exception_handler(Exception, ExceptionAdapter.global_exception_handler)
