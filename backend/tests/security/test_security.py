...
class TestXXEProtection:
    ...
    def test_xxe_attack_blocked(self):
        ...
        adapter = XmlAdapter()
        file = File(name="malicious.xml", content=xxe_payload, size=len(xxe_payload), extension="xml")
...
class TestExceptionSanitization:
    ...
    def test_production_errors_sanitized(self):
        ...
        exc = Exception("Sensitive database connection string: postgresql://user:pass@host/db")
