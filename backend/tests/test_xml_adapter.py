...
class TestXmlAdapterExtraction:
    ...
    def test_extract_simple_structure_default_mode(self, simple_xml, create_file_entity):
        """
    ...
    def test_extract_nested_repeated_elements(self, nested_xml, create_file_entity):
        """
...
class TestXmlAdapterStatistics:
    ...
    def test_statistics_with_empty_tags(self, empty_tags_xml, create_file_entity):
        ...
        result = adapter.extract(file, tags=['field1', 'field2', 'field3', 'field4'])
    ...
    def test_parent_tags_not_counted_as_empty(self, nested_xml, create_file_entity):
        """
...
class TestXmlAdapterPriorityTags:
    ...
    def test_extract_priority_tags(self, simple_xml, create_file_entity):
        ...
        result = adapter.extract(file, tags=['NAME', 'AGE'], priority_tags=['NAME', 'AGE'])
