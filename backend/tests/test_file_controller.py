...
class TestFileControllerUpload:
    ...
    @pytest.mark.asyncio
    async def test_upload_valid_file(self, simple_xml, mock_notifier, temp_output_dir):
        """
    ...
    @pytest.mark.asyncio
    async def test_upload_with_specific_tags(self, simple_xml, mock_notifier, temp_output_dir):
        """
    ...
    @pytest.mark.asyncio
    async def test_upload_with_custom_formats(self, simple_xml, mock_notifier, temp_output_dir):
        """
    ...
    @pytest.mark.asyncio
    async def test_upload_defaults_to_both_formats(self, simple_xml, mock_notifier, temp_output_dir):
        """
...
class TestFileControllerEntityConversion:
    ...
    @pytest.mark.asyncio
    async def test_converts_upload_file_to_file_entity(self, simple_xml, mock_notifier, temp_output_dir):
        """
    ...
    @pytest.mark.asyncio
    async def test_handles_missing_filename(self, simple_xml, mock_notifier, temp_output_dir):
        """
...
class TestFileControllerErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_propagates_invalid_xml_error(self, invalid_xml, mock_notifier, temp_output_dir):
        """
    ...
    @pytest.mark.asyncio
    async def test_propagates_tags_not_found_error(self, simple_xml, mock_notifier, temp_output_dir):
        """
